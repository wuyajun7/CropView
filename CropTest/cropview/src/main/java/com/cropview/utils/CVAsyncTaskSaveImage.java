 ...
 * 其次执行doInBackgroup方法
 */
public class CVAsyncTaskSaveImage extends AsyncTask<Integer, Integer, String> {
    ...
    public CVAsyncTaskSaveImage(Bitmap _bitmap, String _imgName, int _imgMass, ISaveImgListener _iSaveImgListener) {
        super();
