package com.cropview.controller;
...
public class CVCropImageView extends ImageView {
    private static final String TAG = CVCropImageView.class.getSimpleName();
    ...
    public CVCropImageView(Context context) {
        this(context, null);
    }

    public CVCropImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CVCropImageView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void setmCropMode(CropMode mCropMode) {
